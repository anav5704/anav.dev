...
You don't have to come up with the perfect website on your first go. List out some basic requirements and just start building. This includes this like how you want your website to look like. So go choose a nice [color palette](https://colorhunt.co) and some [fonts](https://fonts.google.com) that fit your style.  Another important thing to get sorted is the pages you plan to build out. You could consider starting with a home, about and contact page. Later, you can add a projects page when you have build a handful of projects. And if you need some inspiration, feel free to look up [portfolio websites](https://dribbble.com/tags/personal-website) and how those sites structure their content.
