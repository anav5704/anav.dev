...
Luckily, [getters and setters](https://www.anav.dev/blogs/simplifying-oop-for-cs112-part-2-understanding-encapsulation#getters-and-setters) exist for this sole purpose. For each each attribute, it is recommended to create a getter and setter method.
